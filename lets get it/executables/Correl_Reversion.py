...
if yhat_diff.values > 0:
    send_order('EURUSD.a', 'sell', 2.50, 'Correl_Rev_D')
    send_order('GBPUSD.a', 'buy', 2.30, 'Correl_Rev_D')
elif yhat_diff.values < 0:
    send_order('EURUSD.a', 'buy', 2.50, 'Correl_Rev_D')
    send_order('GBPUSD.a', 'sell', 2.30, 'Correl_Rev_D')
...
if yhat_diff.values > 0:
    send_order('EURUSD.a', 'buy', 2.50, 'Correl_Rev_EU')
elif yhat_diff.values < 0:
    send_order('EURUSD.a', 'sell', 2.50, 'Correl_Rev_EU')
...
if yhat_diff.values > 0:
    send_order('GBPUSD.a', 'buy', 2.30, 'Correl_Rev_GU')
elif yhat_diff.values < 0:
    send_order('GBPUSD.a', 'sell', 2.30, 'Correl_Rev_GU')
